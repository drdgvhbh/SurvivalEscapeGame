...
public static class NourishmentLevels {
    ...
    private static double RegenerationN = 1.75;
    private static double DecayN = 1/1.2;
    private static double MsN = 1.6;
    ...
    public static Dictionary<int, float> BaseHealthRegeneration = new Dictionary<int, float>() {
        { -2, (float)System.Math.Pow(RegenerationN, -2) * LowMultiplier },
        { -1, (float)System.Math.Pow(RegenerationN, -1) * LowMultiplier },
        { 0, (float)System.Math.Pow(RegenerationN, 0) * LowMultiplier },
        { 1, (float)System.Math.Pow(RegenerationN, 1) * LowMultiplier },
        { 2, (float)System.Math.Pow(RegenerationN, 2) * LowMultiplier }
    };
